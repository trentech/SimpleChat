...
public class Commands {
	...
	public CommandSpec cmdMessage = CommandSpec.builder()
		    ...
		    .arguments(//element, 
		    		GenericArguments.player(Text.of("player")), GenericArguments.remainingJoinedStrings(Text.of("message")))
	...
	public CommandSpec cmdMail = CommandSpec.builder()
		    ...
		    .arguments(//element, 
		    		GenericArguments.optional(GenericArguments.user(Text.of("user"))), GenericArguments.remainingJoinedStrings(Text.of("message")))
	...
	private CommandSpec cmdRange = CommandSpec.builder()
		    ...
		    .arguments(//element, 
		    		GenericArguments.bool(Text.of("true|false")), GenericArguments.optional(GenericArguments.integer(Text.of("value"))))
